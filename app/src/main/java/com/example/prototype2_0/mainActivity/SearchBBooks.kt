...
class SearchBBooks : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        getBBorrowedFromSearch(query)
    }

    private fun getBBorrowedFromSearch(query: String) {
        val url = "https://library123456.000webhostapp.com/GetBBorrowedFromSearch.php"
        ...
        val postRequest = object : StringRequest(
            Method.POST, url, Response.Listener<String>
            {
                ...
                try {
                    ...
                    if (status == "ok") {
                        try {
                            borrowed_books_recycler_view.layoutManager =
